 ...
 */
final class Version20211031093812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__email AS SELECT id, sent_by_id, identifier, type, link, sent_date_time, read_at, body FROM email');
        ...
        , type INTEGER NOT NULL, link CLOB DEFAULT NULL COLLATE BINARY, sent_date_time DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, body CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_E7927C74A45BB98C FOREIGN KEY (sent_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO email (id, sent_by_id, identifier, type, link, sent_date_time, read_at, body) SELECT id, sent_by_id, identifier, type, link, sent_date_time, read_at, body FROM __temp__email');
        ...
        , identifier VARCHAR(255) NOT NULL COLLATE BINARY, min_registrations INTEGER NOT NULL, public BOOLEAN NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, title CLOB NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, start_date DATETIME NOT NULL, parts INTEGER DEFAULT NULL, public_notification_sent DATETIME DEFAULT NULL, sufficient_registrations_notification_sent DATETIME DEFAULT NULL, author CLOB DEFAULT NULL COLLATE BINARY, experience CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_3BAE0AA7BA2D8762 FOREIGN KEY (lecturer_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E7927C74A45BB98C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__email AS SELECT id, sent_by_id, identifier, type, link, body, sent_date_time, read_at FROM email');
        $this->addSql('DROP TABLE email');
        ...
        , type INTEGER NOT NULL, link CLOB DEFAULT NULL, body CLOB DEFAULT NULL, sent_date_time DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO email (id, sent_by_id, identifier, type, link, body, sent_date_time, read_at) SELECT id, sent_by_id, identifier, type, link, body, sent_date_time, read_at FROM __temp__email');
        $this->addSql('DROP TABLE __temp__email');
        $this->addSql('CREATE INDEX IDX_E7927C74A45BB98C ON email (sent_by_id)');
        $this->addSql('DROP INDEX UNIQ_3BAE0AA7772E836A');
        $this->addSql('DROP INDEX IDX_3BAE0AA7BA2D8762');
        ...
        , identifier VARCHAR(255) NOT NULL, min_registrations INTEGER NOT NULL, public BOOLEAN NOT NULL, public_notification_sent DATETIME DEFAULT NULL, sufficient_registrations_notification_sent DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, title CLOB NOT NULL, description CLOB NOT NULL, start_date DATETIME NOT NULL, parts INTEGER DEFAULT NULL, author CLOB DEFAULT NULL, experience CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
