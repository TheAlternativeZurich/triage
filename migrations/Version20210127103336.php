 ...
 */
final class Version20210127103336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, lecturer_id, identifier, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts FROM event');
        ...
        $this->addSql('INSERT INTO event (id, lecturer_id, identifier, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts) SELECT id, lecturer_id, identifier, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts FROM __temp__event');
