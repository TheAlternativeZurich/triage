 ...
 */
final class Version20210119132408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, name, description, start_date, parts FROM event');
        ...
        , experience CLOB NOT NULL COLLATE BINARY, min_registrations INTEGER NOT NULL, public BOOLEAN NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, description CLOB NOT NULL COLLATE BINARY, start_date DATETIME NOT NULL, parts INTEGER DEFAULT NULL, title CLOB NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_3BAE0AA7BA2D8762 FOREIGN KEY (lecturer_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts) SELECT id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, name, description, start_date, parts FROM __temp__event');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E7927C74A45BB98C ON email (sent_by_id)');
        $this->addSql('DROP INDEX IDX_3BAE0AA7BA2D8762');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id CHAR(36) NOT NULL --(DC2Type:guid)
        , lecturer_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , experience CLOB NOT NULL, min_registrations INTEGER NOT NULL, public BOOLEAN NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, description CLOB NOT NULL, start_date DATETIME NOT NULL, parts INTEGER DEFAULT NULL, name CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event (id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, name, description, start_date, parts) SELECT id, lecturer_id, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7BA2D8762 ON event (lecturer_id)');
        $this->addSql('DROP INDEX IDX_62A8A7A771F7E88B');
        $this->addSql('DROP INDEX IDX_62A8A7A7A76ED395');
