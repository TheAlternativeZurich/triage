 ...
 */
final class Version20210223173921 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , type INTEGER NOT NULL, link CLOB DEFAULT NULL COLLATE BINARY, sent_date_time DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_E7927C74A45BB98C FOREIGN KEY (sent_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, lecturer_id, identifier, experience, min_registrations, public, created_at, last_changed_at, title, description, start_date, parts, public_notification_sent, sufficient_registrations_notification_sent FROM event');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3BAE0AA7772E836A');
        $this->addSql('DROP INDEX IDX_3BAE0AA7BA2D8762');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, lecturer_id, identifier, experience, min_registrations, public, public_notification_sent, sufficient_registrations_notification_sent, created_at, last_changed_at, title, description, start_date, parts FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id CHAR(36) NOT NULL --(DC2Type:guid)
        , lecturer_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , identifier VARCHAR(255) NOT NULL, experience CLOB NOT NULL, min_registrations INTEGER NOT NULL, public BOOLEAN NOT NULL, public_notification_sent DATETIME DEFAULT NULL, sufficient_registrations_notification_sent DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, title CLOB NOT NULL, description CLOB NOT NULL, start_date DATETIME NOT NULL, parts INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event (id, lecturer_id, identifier, experience, min_registrations, public, public_notification_sent, sufficient_registrations_notification_sent, created_at, last_changed_at, title, description, start_date, parts) SELECT id, lecturer_id, identifier, experience, min_registrations, public, public_notification_sent, sufficient_registrations_notification_sent, created_at, last_changed_at, title, description, start_date, parts FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3BAE0AA7772E836A ON event (identifier)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7BA2D8762 ON event (lecturer_id)');
        $this->addSql('DROP INDEX IDX_62A8A7A771F7E88B');
